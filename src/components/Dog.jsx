...
function Dog() {
  ...
  useEffect(() => {
    ...
    document.querySelector(`.title-item[img-title="msi-chicago"]`).addEventListener("mouseenter", () => {
      console.log("add .");
    ...
    document.querySelector(`.title-item[img-title="phone"]`).addEventListener("mouseenter", () => {
    ...
    document.querySelector(`.title-item[img-title="kikk"]`).addEventListener("mouseenter", () => {
    ...
    document.querySelector(`.title-item[img-title="kennedy"]`).addEventListener("mouseenter", () => {
      material.current.uMatcap1.value = mat8;
      gsap.to(material.current.uProgress, {
        value: 0.0,
        duration: 0.3,
    ...
    document.querySelector(`.title-item[img-title="opera"]`).addEventListener("mouseenter", () => {
